...
namespace Clients.WebClient.Pages.Fumigacion.Facturas
{
    public class FacturacionModel : PageModel
    {
        ...
        private readonly IFCFDIProxy _cfdi;
        ...
        public FacturacionModel(IInmuebleProxy inmuebles, IMesProxy mes, IFRepositorioProxy facturacion, IModuloProxy modulo, IFCedulaProxy cedula,
                                IPermisoProxy permisos, IEstatusCedulaProxy estatusc, ICTServicioProxy servicios, IFCFDIProxy cfdi)
        {
            _modulo = modulo;
            _mes = mes;
