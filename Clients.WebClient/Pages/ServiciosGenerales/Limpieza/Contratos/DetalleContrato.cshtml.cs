...
namespace Clients.WebClient.Pages.Limpieza.Contratos
{
    public class DetalleContratoModel : PageModel
    {
        ...
        public DetalleContratoModel(IModuloProxy modulo, ICTServicioProxy servicios, ILContratoProxy contratos, ILConvenioProxy convenios, 
                                    ILServicioContratoProxy scontrato, ILEContratoProxy entregables, ILParametroProxy variables, IPermisoProxy permisos, 
