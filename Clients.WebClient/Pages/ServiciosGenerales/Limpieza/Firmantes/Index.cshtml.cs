...
namespace Clients.WebClient.Pages.Limpieza.Firmantes
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IModuloProxy modulo, ICTServicioProxy servicios, ILFirmanteProxy firmantes, IPermisoProxy permisos, 
