...
namespace Clients.WebClient.Pages.Convencional.Contratos
{
    public class DetalleContratoModel : PageModel
    {
        ...
        private readonly IQContratoConvencionalProxy _contratosQuery;
        private readonly ICContratoConvencionalProxy _contratosCommand;

        private readonly IQConvenioConvencionalProxy _conveniosQuery;
        private readonly ICConvenioConvencionalProxy _conveniosCommand;

        private readonly IQSContratoConvencionalProxy _scontratoQuery;
        private readonly ICSContratoConvencionalProxy _scontratoCommand;

        private readonly IQEContratoConvencionalProxy _entregablesQuery;
        private readonly ICEContratoConvencionalProxy _entregablesCommand;
        ...
        public DetalleContratoModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoConvencionalProxy contratosQuery, 
                                    ICContratoConvencionalProxy contratosCommand, IQConvenioConvencionalProxy conveniosQuery, 
                                    ICConvenioConvencionalProxy conveniosCommand, IQSContratoConvencionalProxy scontratoQuery, 
                                    ICSContratoConvencionalProxy scontratoCommand, IQEContratoConvencionalProxy entregablesQuery, 
                                    ICEContratoConvencionalProxy entregablesCommand, IPermisoProxy permisos, 
