...
using Api.Gateway.WebClient.Proxy.Convencional.Contratos;
...
namespace Clients.WebClient.Pages.Convencional.Contratos
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoConvencionalProxy contratosQuery, 
                          ICContratoConvencionalProxy contratosCommand, IPermisoProxy permisos)
        {
            _modulo = modulo;
