...
namespace Clients.WebClient.Pages.Celular.Contratos
{
    public class DetalleContratoModel : PageModel
    {
        ...
        private readonly IQContratoCelularProxy _contratosQuery;
        private readonly ICContratoCelularProxy _contratosCommand;

        private readonly IQConvenioCelularProxy _conveniosQuery;
        private readonly ICConvenioCelularProxy _conveniosCommand;

        private readonly IQSContratoCelularProxy _scontratoQuery;
        private readonly ICSContratoCelularProxy _scontratoCommand;

        private readonly IQEContratoCelularProxy _entregablesQuery;
        private readonly ICEContratoCelularProxy _entregablesCommand;
        ...
        public DetalleContratoModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoCelularProxy contratosQuery, 
                                    ICContratoCelularProxy contratosCommand, IQConvenioCelularProxy conveniosQuery, 
                                    ICConvenioCelularProxy conveniosCommand, IQSContratoCelularProxy scontratoQuery, 
                                    ICSContratoCelularProxy scontratoCommand, IQEContratoCelularProxy entregablesQuery, 
                                    ICEContratoCelularProxy entregablesCommand, IPermisoProxy permisos, 
