...
using Api.Gateway.WebClient.Proxy.Celular.Contratos;
...
namespace Clients.WebClient.Pages.Celular.Contratos
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoCelularProxy contratosQuery, 
                          ICContratoCelularProxy contratosCommand, IPermisoProxy permisos)
        {
            _modulo = modulo;
