...
namespace Clients.WebClient.Pages.Mensajeria.Facturas
{
    public class IndexModel : PageModel
    {
        ...
        private readonly ICRepositorioMensajeriaProxy _repositoriosCommand;
        ...
        public IndexModel(IModuloProxy modulo, IMesProxy mes, IQContratoMensajeriaProxy contratos, IQRepositorioMensajeriaProxy repositoriosQuery, 
                          ICRepositorioMensajeriaProxy repositoriosCommand, ICTServicioProxy servicios, IPermisoProxy permisos)
        {
            _modulo = modulo;
            _mes = mes;
