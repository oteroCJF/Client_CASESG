...
namespace Clients.WebClient.Pages.Mensajeria.Facturas
{
    public class CargaFacturasModel : PageModel
    {
        ...
        public CargaFacturasModel(IModuloProxy modulo, IInmuebleProxy inmuebles, IQRepositorioMensajeriaProxy repositorios, 
                                  IQCFDIMensajeriaProxy facturasQuery, ICCFDIMensajeriaProxy facturasCommand, ICTServicioProxy servicios, 
