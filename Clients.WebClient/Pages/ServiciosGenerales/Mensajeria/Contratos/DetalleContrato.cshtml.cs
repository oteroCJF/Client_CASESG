...
namespace Clients.WebClient.Pages.Mensajeria.Contratos
{
    public class DetalleContratoModel : PageModel
    {
        ...
        private readonly ICContratoMensajeriaProxy _contratosCommand;

        private readonly IQConvenioMensajeriaProxy _conveniosQuery;
        private readonly ICConvenioMensajeriaProxy _conveniosCommand;

        private readonly IQSContratoMensajeriaProxy _scontratoQuery;
        private readonly ICSContratoMensajeriaProxy _scontratoCommand;

        private readonly IQEContratoMensajeriaProxy _entregablesQuery;
        private readonly ICEContratoMensajeriaProxy _entregablesCommand;

        private readonly IMParametroProxy _variables;
        ...
        public DetalleContratoModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoMensajeriaProxy contratosQuery, 
                                    ICContratoMensajeriaProxy contratosCommand, IQConvenioMensajeriaProxy conveniosQuery, 
                                    ICConvenioMensajeriaProxy conveniosCommand, IQSContratoMensajeriaProxy scontratoQuery, 
                                    ICSContratoMensajeriaProxy scontratoCommand, IQEContratoMensajeriaProxy entregablesQuery, 
                                    ICEContratoMensajeriaProxy entregablesCommand, IPermisoProxy permisos, 
