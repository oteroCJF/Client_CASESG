...
namespace Clients.WebClient.Pages.Mensajeria.Contratos
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoMensajeriaProxy contratosQuery, 
                          ICContratoMensajeriaProxy contratosCommand, IPermisoProxy permisos)
        {
            _modulo = modulo;
