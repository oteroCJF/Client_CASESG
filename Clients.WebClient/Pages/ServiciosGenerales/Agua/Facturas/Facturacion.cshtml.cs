...
namespace Clients.WebClient.Pages.Agua.Facturas
{
    public class FacturacionModel : PageModel
    {
        ...
        public FacturacionModel(IMesProxy mes, IInmuebleProxy inmuebles, IQRepositorioAguaProxy repositoriosQuery, 
                                IQCFDIAguaProxy cfdi, IQCedulaAguaProxy cedula, IEstatusCedulaProxy estatusc, 
