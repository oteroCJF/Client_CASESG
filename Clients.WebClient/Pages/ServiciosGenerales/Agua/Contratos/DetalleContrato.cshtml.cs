...
namespace Clients.WebClient.Pages.Agua.Contratos
{
    public class DetalleContratoModel : PageModel
    {
        ...
        private readonly IQConvenioAguaProxy _conveniosQuery;
        private readonly ICConvenioAguaProxy _conveniosCommand;

        private readonly IQSContratoAguaProxy _scontratoQuery;
        private readonly ICSContratoAguaProxy _scontratoCommand;

        private readonly IQEContratoAguaProxy _entregablesQuery;
        private readonly ICEContratoAguaProxy _entregablesCommand;
        ...
        public DetalleContratoModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoAguaProxy contratosQuery, 
                                    ICContratoAguaProxy contratosCommand, IQConvenioAguaProxy conveniosQuery, 
                                    ICConvenioAguaProxy conveniosCommand, IQSContratoAguaProxy scontratoQuery, 
                                    ICSContratoAguaProxy scontratoCommand, IQEContratoAguaProxy entregablesQuery, 
                                    ICEContratoAguaProxy entregablesCommand, IPermisoProxy permisos, 
