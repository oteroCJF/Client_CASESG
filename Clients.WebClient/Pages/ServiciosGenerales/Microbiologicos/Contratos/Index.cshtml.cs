...
using Api.Gateway.WebClient.Proxy.Microbiologicos.Contratos;
...
namespace Clients.WebClient.Pages.Microbiologicos.Contratos
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoMicrobiologicosProxy contratosQuery, 
                          ICContratoMicrobiologicosProxy contratosCommand, IPermisoProxy permisos)
        {
            _modulo = modulo;
