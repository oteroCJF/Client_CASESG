...
namespace Clients.WebClient.Pages.Comedor.Contratos
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoComedorProxy contratosQuery, 
                          ICContratoComedorProxy contratosCommand, IPermisoProxy permisos)
        {
            _modulo = modulo;
