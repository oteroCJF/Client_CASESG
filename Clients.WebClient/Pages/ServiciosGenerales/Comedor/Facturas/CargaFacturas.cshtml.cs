...
namespace Clients.WebClient.Pages.Comedor.Facturas
{
    public class CargaFacturasModel : PageModel
    {
        ...
        private readonly ICCFDIComedorProxy _facturasCommand;
        ...
        public CargaFacturasModel(IModuloProxy modulo, IInmuebleProxy inmuebles, IQRepositorioComedorProxy repositorios,
                                  IQCFDIComedorProxy facturasQuery, ICCFDIComedorProxy facturasCommand, 
                                  ICTServicioProxy servicios,
        ...
        private static DataTable CreateTable(List<HistorialMFDto> historial)
        {
            ...
            dt.Columns.Add("Elaboro", typeof(string));
