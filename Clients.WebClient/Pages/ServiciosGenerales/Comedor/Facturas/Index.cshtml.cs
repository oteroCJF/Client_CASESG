...
namespace Clients.WebClient.Pages.Comedor.Facturas
{
    public class IndexModel : PageModel
    {
        ...
        private readonly ICRepositorioComedorProxy _repositoriosCommand;
        ...
        public IndexModel(IModuloProxy modulo, IMesProxy mes, IQContratoComedorProxy contratos, IQRepositorioComedorProxy repositoriosQuery, 
                          ICRepositorioComedorProxy repositoriosCommand, ICTServicioProxy servicios, IPermisoProxy permisos)
        {
            _modulo = modulo;
            _mes = mes;
