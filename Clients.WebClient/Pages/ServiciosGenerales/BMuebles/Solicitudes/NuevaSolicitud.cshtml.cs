...
{
    public class NuevaSolicitudModel : PageModel
    {
        ...
        public NuevaSolicitudModel(IModuloProxy modulo, ICTServicioProxy servicios, IInmuebleProxy inmuebles, IQBMSolicitudProxy solicitudesQuery,
        ...
        public async Task OnGet(int moduloId, int submoduloId, int anio)
        {
        ...
        public async Task<IActionResult> OnPostCreateSolicitud([FromBody] SolicitudCreateCommand request)
        {
            var solicitud = await _solicitudesCommand.CreateSolicitud(request);
