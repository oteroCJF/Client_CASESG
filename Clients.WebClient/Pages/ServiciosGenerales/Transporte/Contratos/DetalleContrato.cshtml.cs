...
namespace Clients.WebClient.Pages.Transporte.Contratos
{
    public class DetalleContratoModel : PageModel
    {
        ...
        private readonly IQContratoTransporteProxy _contratosQuery;
        private readonly ICContratoTransporteProxy _contratosCommand;

        private readonly IQConvenioTransporteProxy _conveniosQuery;
        private readonly ICConvenioTransporteProxy _conveniosCommand;

        private readonly IQSContratoTransporteProxy _scontratoQuery;
        private readonly ICSContratoTransporteProxy _scontratoCommand;

        private readonly IQEContratoTransporteProxy _entregablesQuery;
        private readonly ICEContratoTransporteProxy _entregablesCommand;
        ...
        public DetalleContratoModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoTransporteProxy contratosQuery, 
                                    ICContratoTransporteProxy contratosCommand, IQConvenioTransporteProxy conveniosQuery, 
                                    ICConvenioTransporteProxy conveniosCommand, IQSContratoTransporteProxy scontratoQuery, 
                                    ICSContratoTransporteProxy scontratoCommand, IQEContratoTransporteProxy entregablesQuery, 
                                    ICEContratoTransporteProxy entregablesCommand, IPermisoProxy permisos, 
