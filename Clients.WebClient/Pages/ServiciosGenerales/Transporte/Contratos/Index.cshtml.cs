...
using Api.Gateway.WebClient.Proxy.Transporte.Contratos;
...
namespace Clients.WebClient.Pages.Transporte.Contratos
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IModuloProxy modulo, ICTServicioProxy servicios, IQContratoTransporteProxy contratosQuery, 
                          ICContratoTransporteProxy contratosCommand, IPermisoProxy permisos)
        {
            _modulo = modulo;
