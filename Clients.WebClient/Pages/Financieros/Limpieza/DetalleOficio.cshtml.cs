...
namespace Clients.WebClient.Pages.Financieros.Limpieza
{
    public class DetalleOficioModel : PageModel
    {
        ...
        private readonly ILCFDIProxy _cfdis;
        ...
        public DetalleOficioModel(ICTServicioProxy servicios, IFDetalleServicioProxy detalle, IInmuebleProxy inmuebles, 
                                  IMesProxy meses, IModuloProxy modulos, IPermisoProxy permisos, ILOficioProxy oficios, 
                                  ILCFDIProxy cfdis, IEstatusOficioProxy flujo, IEstatusFacturaProxy efacturas)
        {
