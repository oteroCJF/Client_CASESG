...
namespace Clients.WebClient.Pages.Financieros.Fumigacion
{
    public class DetalleServicioModel : PageModel
    {
        ...
        public DetalleServicioModel(ICTServicioProxy servicios, ICTEntregableProxy ctentregables, IEstatusEntregableProxy estatuse, 
                                    IFDetalleServicioProxy detalle, IFEntregableProxy entregables, IInmuebleProxy inmuebles, IMesProxy meses, 
                                    IModuloProxy modulos, IPermisoProxy permisos, IFOficioProxy oficios, IFContratoProxy contratos)
        {
