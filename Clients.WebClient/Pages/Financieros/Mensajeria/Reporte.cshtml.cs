...
namespace Clients.WebClient.Pages.Financieros.Mensajeria
{
    public class ReporteModel : PageModel
    {
        ...
        public ReporteModel(ICTServicioProxy servicios, IModuloProxy modulos, IPermisoProxy permisos, IQContratoMensajeriaProxy contratosQuery, IQCedulaMensajeriaProxy cedulas, IInmuebleProxy inmuebles, IMesProxy meses)
        {
